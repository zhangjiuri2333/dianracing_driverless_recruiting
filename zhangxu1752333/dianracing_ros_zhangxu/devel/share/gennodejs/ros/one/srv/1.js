...
class 1Request {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type 1Request
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type 1Request
    let len;
    let data = new 1Request(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new 1Request(null);
    if (msg.a !== undefined) {
      resolved.a = msg.a;
    }
    else {
...
class 1Response {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type 1Response
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type 1Response
    let len;
    let data = new 1Response(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new 1Response(null);
