...
class zRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type zRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type zRequest
    let len;
    let data = new zRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new zRequest(null);
    if (msg.a !== undefined) {
      resolved.a = msg.a;
    }
    else {
...
class zResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type zResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type zResponse
    let len;
    let data = new zResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new zResponse(null);
