...
"""autogenerated by genpy from one/1Request.msg. Do not edit."""
import sys
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(1Request, self).__init__(*args, **kwds)
...
def _get_struct_3q():
    ...
    return _struct_3q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from one/1Response.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(1Response, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.sum is None:
        self.sum = 0
    else:
...
class 1(object):
  ...
  _request_class  = 1Request
  _response_class = 1Response
