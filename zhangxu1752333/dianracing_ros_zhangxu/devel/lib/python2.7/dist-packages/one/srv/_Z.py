...
"""autogenerated by genpy from one/ZRequest.msg. Do not edit."""
import sys
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ZRequest, self).__init__(*args, **kwds)
...
def _get_struct_3q():
    ...
    return _struct_3q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from one/ZResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ZResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.sum is None:
        self.sum = 0
    else:
...
class Z(object):
  ...
  _request_class  = ZRequest
  _response_class = ZResponse
